...
`node "C:/Users/Administrator/.codex/plugins/cc/scripts/claude-companion.mjs" task ...`
...
- If none of `--resume`, `--resume-last`, or `--fresh` is present, first run:
  `node "C:/Users/Administrator/.codex/plugins/cc/scripts/claude-companion.mjs" task-resume-candidate --json`
...
- Before spawning the built-in child, capture the task job id plus routing context in one call:
  `node "C:/Users/Administrator/.codex/plugins/cc/scripts/claude-companion.mjs" background-routing-context --kind task --json`
