...
`node "C:/Users/Administrator/.codex/plugins/cc/scripts/claude-companion.mjs" adversarial-review ...`
...
Foreground flow:
- Run:
  `node "C:/Users/Administrator/.codex/plugins/cc/scripts/claude-companion.mjs" adversarial-review --view-state on-success <arguments with --wait/--background removed>`
...
- Before spawning the built-in child, capture the review job id plus routing context in one call:
  `node "C:/Users/Administrator/.codex/plugins/cc/scripts/claude-companion.mjs" background-routing-context --kind review --json`
...
- The built-in child must be a pure forwarder. It should:
  ...
  - execute:
    `node "C:/Users/Administrator/.codex/plugins/cc/scripts/claude-companion.mjs" adversarial-review --view-state defer <arguments with --wait/--background removed>`
