...
`node "C:/Users/Administrator/.codex/plugins/cc/scripts/claude-companion.mjs" review ...`
...
Foreground flow:
- Run:
  `node "C:/Users/Administrator/.codex/plugins/cc/scripts/claude-companion.mjs" review --view-state on-success <arguments with --wait/--background removed>`
...
- The built-in child must be a pure forwarder. It should:
  ...
  - execute:
    `node "C:/Users/Administrator/.codex/plugins/cc/scripts/claude-companion.mjs" review --view-state defer <arguments with --wait/--background removed>`
