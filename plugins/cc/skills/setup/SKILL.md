...
Do not derive the companion path from this skill file or any cache directory. Always run the installed copy under `C:/Users/Administrator/.codex/plugins/cc`.
...
- First run the machine-readable probe:
  `node "C:/Users/Administrator/.codex/plugins/cc/scripts/claude-companion.mjs" setup --json $ARGUMENTS`
...
- If setup reports missing hooks, run:
  `node "C:/Users/Administrator/.codex/plugins/cc/scripts/install-hooks.mjs"`
...
- After the decision flow is complete, run the final user-facing command without `--json`:
  `node "C:/Users/Administrator/.codex/plugins/cc/scripts/claude-companion.mjs" setup $ARGUMENTS`
